  ...
  return (
    <div className="relative bg-white w-full h-[1024px] overflow-hidden text-left text-sm text-black font-alatsi">
      <div className="absolute top-[112px] left-[1213px] w-[208px] h-[36px]">
        ...
        <div className="absolute top-[0px] left-[91px] w-[117px] h-[36px] font-akshar">
          <div className="absolute top-[0px] left-[0px] rounded-[4px] bg-gray-500 w-[117px] h-[36px]" />
          <div className="absolute top-[5px] left-[16px] inline-block w-[68px] h-[27px]">
            English
          </div>
          <img
            className="absolute top-[13px] left-[89.67px] w-[21.65px] h-[15px]"
            alt=""
            src="../polygon-1.svg"
          />
        </div>
      ...
      <div className="absolute top-[221px] left-[79px] w-[1325px] h-[307px] text-base">
      ...
      <div className="absolute top-[828px] left-[-58px] w-[1520px] h-[209px]">
        <div className="absolute top-[0px] left-[0px] [border:1px_solid_#000] box-border w-[1520px] h-[209px]" />
        <div
          className="absolute top-[124px] left-[690px] w-[239px] h-[53px] cursor-pointer text-gray-100"
        ...
        <div className="absolute top-[29px] left-[84px] w-[161px] h-[142px] text-lg font-akshar">
          <div
          ...
          <div className="absolute top-[100px] left-[38px] inline-block w-[104px] h-[27px]">
            Previous
          </div>
          <img
        ...
        />
        <div className="absolute top-[17px] left-[161px] text-base font-alata text-justify inline-block w-[1325px]">
