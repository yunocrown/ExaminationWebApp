...
const Desktop7 = () => {
  ...
  return (
    <div className="relative bg-white w-full h-[1024px] overflow-hidden text-left text-base text-black font-alatsi">
      <button className="cursor-pointer [border:none] p-[0] bg-[transparent] absolute top-[112px] left-[1213px] w-[208px] h-[36px]">
        <div className="absolute top-[0px] left-[0px] text-sm font-alatsi text-black text-left inline-block w-[86px] h-[27px]">
          View in:
        </div>
        <div className="absolute top-[0px] left-[91px] w-[117px] h-[36px]">
          <div className="absolute top-[0px] left-[0px] rounded-[4px] bg-gray-500 w-[117px] h-[36px]" />
          <div className="absolute top-[5px] left-[16px] text-sm font-akshar text-black text-left inline-block w-[68px] h-[27px]">
            English
          </div>
          <Button
            className="absolute top-[28px] left-[113px] [transform:_rotate(-180deg)] [transform-origin:0_0]"
            sx={{ width: 25 }}
            variant="contained"
            color="primary"
          >
      ...
      <div className="absolute top-[221px] left-[79px] w-[1345px] h-[696px]">
      ...
      <div className="absolute top-[828px] left-[-58px] w-[1520px] h-[209px] text-sm text-gray-100">
        <div className="absolute top-[0px] left-[0px] [border:1px_solid_#000] box-border w-[1520px] h-[209px]" />
        <div
          className="absolute top-[17px] left-[96px] rounded-[6px] [border:1px_solid_#000] box-border w-[45px] h-[40px] cursor-pointer"
          onClick={onRectangle4Click}
        />
        <div className="absolute top-[124px] left-[690px] w-[239px] h-[53px]">
        ...
        <div
          className="absolute top-[120px] left-[84px] w-[161px] h-[51px] cursor-pointer text-lg text-black font-akshar"
        ...
        >
          ...
          <div className="absolute top-[9px] left-[31px] inline-block w-[104px] h-[27px]">
            Previous
          </div>
        </div>
      </div>
