  ...
  return (
    <div className="relative bg-white w-full h-[1024px] overflow-hidden text-left text-sm text-gray-100 font-alatsi">
      <div className="absolute top-[0px] left-[0px] w-[1444px] h-[1024px]">
        <div className="absolute top-[101px] left-[161px] w-[732px] h-[892px]">
          <div className="absolute top-[805px] left-[141px] w-[503px] h-[87px]">
            <Button
          ...
          <Button
            className="absolute top-[845.99px] left-[419px]"
            sx={{ width: 189 }}
            variant="outlined"
            color="primary"
          >
          ...
          <img
            className="absolute top-[0px] left-[0px] w-[732px] h-[803px] object-cover"
            alt=""
        ...
        <div className="absolute top-[101px] left-[1068px] w-[376px] h-[923px] text-black">
          <div className="absolute top-[0px] left-[0px] w-[376px] h-[923px]">
            ...
            <img
              className="absolute top-[39px] left-[105px] w-[179px] h-[201px] object-cover"
              alt=""
